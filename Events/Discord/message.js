...
module.exports = async(bot, message) => {
 ...
 if(!message.guild){
   if(message.author.bot) return;
   var guild = bot.guilds.cache.find(g => g.id === "771040512526385232")
   const STAFF = guild.roles.cache.find(role => role.name == '771042370992472126')
